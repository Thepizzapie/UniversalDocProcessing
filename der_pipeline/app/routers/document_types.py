...
def get_document_type_templates():
    ...
    templates = {
        ...
        DocumentType.RECEIPT: {
            ...
            "required_fields": ["merchant_name", "transaction_date", "total_amount", "currency"],
            "optional_fields": [
                "merchant_address",
                "transaction_time",
                "tax_amount",
        ...
        DocumentType.ENTRY_EXIT_LOG: {
            ...
            "required_fields": ["person_name", "location"],
            "optional_fields": [
                "person_id",
                "entry_time",
                "exit_time",
...
def get_document_type_template(document_type: DocumentType):
    """Get template for a specific document type."""
    templates = get_document_type_templates()
            ...
            for doc_type in DocumentType:
                ...
                for state in PipelineState:
                    state_stmt = select(Document).where(
                        Document.document_type == doc_type, Document.state == state
                    )
